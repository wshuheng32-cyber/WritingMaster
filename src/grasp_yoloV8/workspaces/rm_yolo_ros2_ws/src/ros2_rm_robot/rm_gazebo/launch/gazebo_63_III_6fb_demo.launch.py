...
def generate_launch_description():
    ...
    urdf_model_path = os.path.join(pkg_share, f'config/gazebo_63_III_description.urdf.xacro')

    
    print("---", urdf_model_path)

    doc = xacro.parse(open(urdf_model_path))
    xacro.process_doc(doc,mappings={"link6_type": "Link6_6fb","base_type": "base_link_III"})
